...
static inline bool ublkdrv_cfq_ack_pop(struct ublkdrv_cmd_ack const cmds[],
				       u8 cmds_len, u8 *phead, u8 const *ptail,
				       struct ublkdrv_cmd_ack *cmd_out)
{
...
static inline bool ublkdrv_cfq_push(struct ublkdrv_cmd cmds[], u8 cmds_len,
				    u8 const *phead, u8 *ptail,
				    struct ublkdrv_cmd const *cmd_in)
{
	u8 const ct = *ptail;
